...
.row.pagination-row .dataTables_info{
    display: block;
}
                    ...
                    @if (is_array($element))
                        @foreach ($element as $page => $url)
                            ...
                            <span aria-current="page">
                                    <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5"><b>{{ $page }}</b></span>
                                </span>
                            </li>                                    
                            @else                                
